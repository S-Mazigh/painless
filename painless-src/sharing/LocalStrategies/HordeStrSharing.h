...
/// @brief This strategy is a hordesat like sharing strategy that uses a reducer to minimize shared clause size.
/// \ingroup local_sharing_strat
class HordeStrSharing : public LocalSharingStrategy
{
public:
    /// Constructors
