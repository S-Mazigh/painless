...
// repeated .Clause clauses = 2;
inline int Clauses::_internal_clauses_size() const {
  return clauses_.size();
}
inline int Clauses::clauses_size() const {
  return _internal_clauses_size();
}
inline void Clauses::clear_clauses() {
  clauses_.Clear();
}
inline ::Clause* Clauses::mutable_clauses(int index) {
  // @@protoc_insertion_point(field_mutable:Clauses.clauses)
  return clauses_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Clause >*
Clauses::mutable_clauses() {
  // @@protoc_insertion_point(field_mutable_list:Clauses.clauses)
  return &clauses_;
}
inline const ::Clause& Clauses::_internal_clauses(int index) const {
  return clauses_.Get(index);
}
inline const ::Clause& Clauses::clauses(int index) const {
  // @@protoc_insertion_point(field_get:Clauses.clauses)
  return _internal_clauses(index);
}
inline ::Clause* Clauses::_internal_add_clauses() {
  return clauses_.Add();
}
inline ::Clause* Clauses::add_clauses() {
  // @@protoc_insertion_point(field_add:Clauses.clauses)
  return _internal_add_clauses();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Clause >&
Clauses::clauses() const {
  // @@protoc_insertion_point(field_list:Clauses.clauses)
  return clauses_;
}
